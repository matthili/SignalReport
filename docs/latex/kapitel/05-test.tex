...
SignalReport wurde mit JUnit 5 umfassend getestet. Die 12 Testklassen -- in Paketen, die die Quellstruktur spiegeln (\texttt{config}, \texttt{measurement}, \texttt{network}, \texttt{storage}, \texttt{report}, \texttt{web}, \texttt{i18n}) -- mit insgesamt 119 Tests decken folgende Bereiche ab:
...
\hline
Unit-Tests (Measurement, HostIdentifier, Config, Measurer, MaintenanceWindow, SessionManager, I18n, GatewayDiscovery, ConnectivityAssessment, ReliabilityReport) & 101 & 100\% \\
\hline
Integrationstests (Statistics, H2MeasurementRepository) & 18 & 100\% \\
\hline
E2E-Tests (manuell: Web-UI, PDF-Export, CSV-Export) & 5 & 100\% \\
\hline
\textbf{Gesamt} & \textbf{119 + 5} & \textbf{100\%} \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{100\% Bestehensquote}: Alle 119 automatisierten Tests laufen reproduzierbar grün -- nachweisbare Qualität für die Prüfung
\end{itemize}
