...
\begin{itemize}
    ...
    \item \textbf{I18nTest} (10 Tests): Schlüssel-Parität aller neun Sprachdateien gegen die Referenz (de.json), Existenz aller im Quellcode verwendeten Platzhalter, Fallback-Verhalten, Sprach-Erkennung
\end{itemize}
...
\hline
\textbf{Gesamt} & \textbf{86 + 5} & \textbf{100\%} \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{100\% Bestehensquote}: Alle 86 automatisierten Tests laufen reproduzierbar grün -- nachweisbare Qualität für die Prüfung
\end{itemize}
