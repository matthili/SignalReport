...
SignalReport wurde mit JUnit 5 umfassend getestet. Die 8 Testklassen mit insgesamt 75 Tests decken folgende Bereiche ab:
...
\begin{itemize}
    ...
    \item \textbf{StatisticsTest} (9 Tests): Mathematisch korrekte Berechnung von 95th Percentile, Jitter und Paketverlust mit realen DB-Abfragen
    \item \textbf{ConfigTest} (17 Tests): Laden/Speichern von Konfiguration, hashPassword, Auth-Verifikation, Theme, Save+Reload
    \item \textbf{H2MeasurementRepositoryTest} (10 Tests): Vollständige Datenbank-Integration mit IP-Tracking, Host-Registrierung
    ...
    \item \textbf{SessionManagerTest} (16 Tests): Nonce-Generierung und -Validierung (Single-Use, Ablauf), Session-Erstellung und -Timeout (24\,h), Rollen\-unter\-schei\-dung (Admin/User), Challenge-Response-Verifikation, Replay-Schutz
\end{itemize}
...
void testP95CalculationWithSortedLatencies() {
    ...
    // Assert
    assertEquals(18, p95Index, "Index fuer 95th Percentile muss 18 sein");
...
\hline
Unit-Tests (Measurement, HostIdentifier, Config, Measurer, Maintenance\-Window, Session\-Manager) & 55 & 100\% \\
\hline
Integrationstests (Statistics, H2MeasurementRepository) & 19 & 100\% \\
\hline
E2E-Tests (manuell: Web-UI, PDF-Export, CSV-Export) & 5 & 100\% \\
\hline
\textbf{Gesamt} & \textbf{75 + 5} & \textbf{100\%} \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{100\% Bestehensquote}: Alle 75 automatisierten Tests laufen reproduzierbar grün -- nachweisbare Qualität für die Prüfung
\end{itemize}
