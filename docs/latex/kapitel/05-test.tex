...
SignalReport wurde mit JUnit 5 umfassend getestet. Die 7 Testklassen mit insgesamt 59 Tests decken folgende Bereiche ab:
...
\hline
Unit-Tests (Measurement, HostIdentifier, Config, Measurer, MaintenanceWindow) & 39 & 100\% \\
\hline
Integrationstests (Statistics, H2MeasurementRepository) & 19 & 100\% \\
\hline
E2E-Tests (manuell: Web-UI, PDF-Export, CSV-Export) & 5 & 100\% \\
\hline
\textbf{Gesamt} & \textbf{59 + 5} & \textbf{100\%} \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{100\% Bestehensquote}: Alle 59 automatisierten Tests laufen reproduzierbar grün -- nachweisbare Qualität für die Prüfung
\end{itemize}
