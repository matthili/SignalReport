...
\begin{itemize}
    ...
    \item Mehrsprachige Oberfläche, PDF- und CSV-Ausgabe (neun Sprachen)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mehrsprachigkeit (i18n)}: Komplette Präsentationsschicht in neun Sprachen (de, en, fr, it, es, pt, tr, pl, uk), erweiterbar ohne Neukompilieren über einen externen \texttt{lang/}-Ordner; eingebettete DejaVu-Unicode-Schrift für PDF-Berichte inkl. Kyrillisch (siehe Abschnitt \ref{subsec:i18n})
\end{itemize}

Wer den exakten Stand zum Zeitpunkt der Diplomprüfung begutachten möchte, findet diesen unter dem Git-Tag \texttt{V1} im GitHub-Repository unter \href{https://github.com/matthili/SignalReport/releases/tag/V1}{https://github.com/matthili/SignalReport/releases/tag/V1}.
